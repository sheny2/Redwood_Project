...
```{r conmbine data set and convert hama}
...
hist.data.frame(all_data_clean%>%
                    dplyr::select(c(humidity, humid_temp, humid_adj, incident_par, reflected_par)))
```
