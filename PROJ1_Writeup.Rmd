...
```{r pairwise for one day, fig.cap="\\label{fig:pairwise_oneday} The pairwise scatterplots of variables of interests on May 15.", echo = F, cache=T, warning=F, out.width="60%", message = F}
