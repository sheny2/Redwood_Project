...
In order to fully understand and utilize the value of large, complex data, statisticians have also developed applicable statistical tools for exploratory data analysis over the years. 
In this report, we present detailed data cleaning and exploration on a real dataset of a redwood tree collected by a group of biological and computer science researchers from University of California, Berkeley [@Tolle05amacroscope].  
...
In addition, each data point's node ID, time, position of sensor were also recorded.  
